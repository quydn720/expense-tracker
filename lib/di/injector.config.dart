...
import 'package:expense_tracker/common/cache/drift_database.dart' as _i3;
import 'package:expense_tracker/common/cache/local_cache.dart' as _i8;
import 'package:expense_tracker/di/injector.dart' as _i13;
import 'package:expense_tracker/features/app/bloc/app_bloc.dart' as _i34;
import 'package:expense_tracker/features/app/data/app_settings.dart' as _i22;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.singleton<_i3.MyDatabase>(driftDatabase.myDatabase);
  ...
  gh.singleton<_i13.AppConfigurations>(
    _i13.DevAppConfigurations(),
    registerFor: {
      _dev,
      _prod,
    },
  ...
  gh.factory<_i18.TransactionsDao>(
      () => _i18.TransactionsDao(gh<_i3.MyDatabase>()));
  gh.singleton<_i19.UserPreferences>(
      _i19.UserPreferences(prefs: gh<_i15.SharedPreferences>()));
  gh.factory<bool>(
    () => sharedPreferencesModule.isOnboardingCompeted,
    instanceName: 'isOnboardingCompleted',
  );
  gh.factory<_i20.CategoryCubit>(
      () => _i20.CategoryCubit(gh<_i21.ICategoryRepository>()));
  gh.factory<_i22.AppSettingService>(
      () => _i22.AppSettingService(gh<_i15.SharedPreferences>()));
  ...
  gh.factory<_i24.CategoriesDao>(
      () => _i24.CategoriesDao(gh<_i3.MyDatabase>()));
  gh.factory<_i25.EditTransactionCubit>(() => _i25.EditTransactionCubit(
        gh<_i26.AddTransactionUseCase>(),
        initialTransaction: gh<_i27.TransactionEntity>(),
      ));
  gh.factory<_i28.ForgotPasswordUseCase>(() =>
      _i28.ForgotPasswordUseCase(auth: gh<_i7.IAuthenticationRepository>()));
  gh.lazySingleton<_i29.GoRouter>(() => devAppLocalPackageModule
      .appRouterDev(gh<String>(instanceName: 'init_location')));
  gh.factory<_i21.ICategoryRepository>(
      () => _i30.LocalCategoryRepository(gh<_i24.CategoriesDao>()));
  gh.factory<_i9.ITransactionRepository>(
    () => _i31.FakeTransactionRepository(gh<_i18.TransactionsDao>()),
    registerFor: {_dev},
  );
  ...
  gh.singleton<_i34.AppBloc>(
      _i34.AppBloc(appSettingService: gh<_i22.AppSettingService>()));
  gh.factory<_i26.AddTransactionUseCase>(
      () => _i26.AddTransactionUseCase(gh<_i9.ITransactionRepository>()));
  return getIt;
}
...
class _$DevAppLocalPackageModule extends _i13.DevAppLocalPackageModule {}

class _$DriftDatabase extends _i13.DriftDatabase {}
