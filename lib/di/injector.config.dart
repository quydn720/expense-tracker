...
import '../bloc/app_bloc.dart' as _i13;
...
import '../features/authentication/domain/usecases/register_with_email_and_pw.dart'
    as _i12;
import '../user_preferences.dart' as _i11;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i10.TransactionRepository>(
      ...
      registerFor: {_prod});
  gh.singleton<_i11.UserPreferences>(
      _i11.UserPreferences(prefs: get<_i9.SharedPreferences>()));
  gh.factory<_i12.VerificationService>(() => _i12.VerificationService());
  gh.factory<bool>(() => sharedPreferencesModule.isOnboardingCompeted,
  ...
  gh.lazySingleton<_i14.GoRouter>(() => devAppLocalPackageModule
      .appRouterDev(get<String>(instanceName: 'init_location')));
  gh.factory<_i12.RegisterWithEmailAndPwUseCase>(() =>
      _i12.RegisterWithEmailAndPwUseCase(
          verificationService: get<_i12.VerificationService>(),
